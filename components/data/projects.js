...
const projects = [
  {
    name: "Tax Breakdown Helper",
    description: [
      "Get a breakdown of your tax details for ITR filing from an HDFC Bank statement.",
    ],
    with: [],
    imageUrl: "",
    link: "",
    ...
    repository: {
      platform: "github",
      url: "https://github.com/DEEJ4Y/tax-analysis",
    },
    language: "javascript",
  },
  {
    name: "Screener Highlighter",
    description: [
      "A browser extension to highlight better results on screener.in.",
      "Built using Vanilla JavaScript.",
    ],
    with: [],
    imageUrl: "/screenshots/screener-highlighter.png",
    link: "https://chromewebstore.google.com/detail/screenerin-better-results/edjinhanokkijkjcnlamjmjonmkjaoka",
    category: "personal",
    tags: ["frontend", "vanillajs", "browser-extension"],
    major: false,
    upcoming: false,
    completed: true,
    repository: {
      platform: "github",
      url: "https://github.com/DEEJ4Y/screener.in-better-result-highlighter-browser-extension",
    },
    language: "javascript",
  },
  {
    ...
    description: [
      "View XIRR for realized trades from Zerodha or Groww.",
      "Upload your Zerodha/Groww trade CSV files and get your equity trading CAGR.",
      "Built with Next.js using static site generation.",
      "Utilized Mantine UI for styling and component design.",
    ],
    with: [],
    imageUrl: "/screenshots/xirr-calculator.png",
    link: "https://cagr-calculator-web.vercel.app/",
    category: "personal",
    tags: ["frontend", "nextjs", "mantine"],
    major: false,
    upcoming: false,
    completed: true,
    repository: {
      platform: "github",
      url: "https://github.com/DEEJ4Y/cagr-calculator-web",
    },
    language: "javascript",
  },
  {
    ...
    description: [
      "Calculate investment returns with an initial sum and SIP.",
      "Built with Next.js using static site generation.",
      "Utilized Mantine UI for styling and component design.",
    ],
    with: [],
    imageUrl: "/screenshots/sip-lumpsum-calculator.png",
    link: "https://sip-lumpsum-calculator-seven.vercel.app/",
    category: "personal",
    tags: ["frontend", "nextjs", "mantine"],
    major: false,
    upcoming: false,
    ...
    repository: {
      platform: "github",
      url: "https://github.com/DEEJ4Y/sip-lumpsum-calculator",
    },
    language: "javascript",
  },
  {
    name: "SplashID Pro 9 - Landing Page & Website",
    with: [],
    description: [
      "Built the website for SplashID Pro 9.",
      "The website is made with Next.js using static HTML export.",
    ],
    imageUrl: "/screenshots/splashid-pro-9.png",
    link: "https://www.splashid.com",
    category: "freelance",
    tags: ["frontend", "next"],
    major: false,
    upcoming: false,
